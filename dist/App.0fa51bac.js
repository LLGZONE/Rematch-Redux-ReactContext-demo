...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"lib/createReducers.js":[function(require,module,exports) {
"use strict";
...
},{}],"lib/actionCreators.js":[function(require,module,exports) {
"use strict";
...
function createActionCreator(type) {
  ...
  return function () {
    ...
    argNames.forEach(function (argName, idx) {
      action[argName] = args[idx];
    });
    return action;
  };
}
},{}],"count/redux/action.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reset = exports.reduce = exports.add = exports.RESET_COUNT = exports.REDUCE_COUNT = exports.ADD_COUNT = void 0;

var _actionCreators = _interopRequireDefault(require("../../lib/actionCreators"));
...
exports.REDUCE_COUNT = REDUCE_COUNT;
var RESET_COUNT = 'RESET_COUNT';
exports.RESET_COUNT = RESET_COUNT;
var add = (0, _actionCreators.default)(ADD_COUNT, 'num');
exports.add = add;
var reduce = (0, _actionCreators.default)(REDUCE_COUNT, 'num');
exports.reduce = reduce;
var reset = (0, _actionCreators.default)(RESET_COUNT);
exports.reset = reset;
},{"../../lib/actionCreators":"lib/actionCreators.js"}],"count/redux/reducer.js":[function(require,module,exports) {
"use strict";
...
var _createReducers = _interopRequireDefault(require("../../lib/createReducers"));

var ActionTypes = _interopRequireWildcard(require("./action"));
...
var count = (0, _createReducers.default)({
  count: 0
}, (_createReducer = {}, _defineProperty(_createReducer, ActionTypes.ADD_COUNT, function (state, action) {
  return {
    count: state.count + 1
  };
}), _defineProperty(_createReducer, ActionTypes.REDUCE_COUNT, function (state, action) {
  return {
    count: state.count - 1
  };
}), _defineProperty(_createReducer, ActionTypes.RESET_COUNT, function (state, action) {
  return {
    count: 0
  };
}), _createReducer));
var _default = count;
exports.default = _default;
},{"../../lib/createReducers":"lib/createReducers.js","./action":"count/redux/action.js"}],"count/redux/store.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"redux":"node_modules/redux/es/redux.js","./reducer":"count/redux/reducer.js"}],"node_modules/prop-types/factoryWithTypeCheckers.js":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    (0, _invariant.default)(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + (methodName + '. Instead received ' + JSON.stringify(WrappedComponent)));
  ...
  return function initMergePropsProxy(dispatch, _ref) {
    ...
    return function mergePropsProxy(stateProps, dispatchProps, ownProps) {
      ...
      if (hasRunOnce) {
        ...
        if (undefined !== 'production') (0, _verifyPlainObject.default)(mergedProps, displayName, 'mergeProps');
      }
...
function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }
},{"./components/Provider":"node_modules/react-redux/es/components/Provider.js","./components/connectAdvanced":"node_modules/react-redux/es/components/connectAdvanced.js","./connect/connect":"node_modules/react-redux/es/connect/connect.js"}],"count/redux/App.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Counter, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", null, React.createElement("div", null, this.props.count), React.createElement("button", {
        onClick: function onClick() {
          return _this.handleClick('add');
        }
      }, "+"), React.createElement("button", {
        onClick: function onClick() {
          return _this.handleClick('reduce');
        }
      }, "-"), React.createElement("button", {
        onClick: function onClick() {
          return _this.handleClick('reset');
        }
      }, "reset"));
    }
  }]);
...
var App = (0, _reactRedux.connect)(mapStateToProps, {
  add: _action.add,
  reduce: _action.reduce,
  reset: _action.reset
})(Counter);
(0, _reactDom.render)(React.createElement(_reactRedux.Provider, {
  store: _store.default
}, React.createElement(App, null)), document.getElementById('root'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./store":"count/redux/store.js","./action":"count/redux/action.js","react-redux":"node_modules/react-redux/es/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","count/redux/App.js"], null)
//# sourceMappingURL=/App.0fa51bac.map